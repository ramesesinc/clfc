...
--
-- Table structure for table `loan_route_collector`
--

DROP TABLE IF EXISTS `loan_route_collector`;
CREATE TABLE `loan_route_collector` (
  `objid` varchar(40) NOT NULL,
  `parentid` varchar(40) default NULL,
  `user_objid` varchar(40) default NULL,
  `user_name` varchar(150) default NULL,
  PRIMARY KEY  (`objid`),
  UNIQUE KEY `uix_userobjid` (`user_objid`),
  KEY `fk_loanroutecollector_parentid_code` (`parentid`),
  CONSTRAINT `fk_loanroutecollector_parentid_code` FOREIGN KEY (`parentid`) REFERENCES `loan_route` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `loan_route_collector`
--

LOCK TABLES `loan_route_collector` WRITE;
/*!40000 ALTER TABLE `loan_route_collector` DISABLE KEYS */;
/*!40000 ALTER TABLE `loan_route_collector` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sys_sequence` VALUES ('ENTITY',1),('loan',1),('loanbill',1);
...
-- Dump completed on 2013-10-14  1:54:44
